/* Application.c generated by valac 0.48.13, the Vala compiler
...
#line 3 "../src/Application.vala"
	self = (Application*) g_object_new (object_type, "application-id", "com.github.fidelisakilan.testgtk", "flags", G_APPLICATION_FLAGS_NONE, NULL);
